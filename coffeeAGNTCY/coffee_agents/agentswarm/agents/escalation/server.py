...
# AgentSwarm - Escalation Agent HTTP Server (No Docker Required!)
...
from config.config import ESCALATION_AGENT_PORT
from config.logging_config import setup_logging

setup_logging()
logger = logging.getLogger("agentswarm.escalation.server")
...
if __name__ == "__main__":
    ...
    print(f" Port: {ESCALATION_AGENT_PORT}")
    print("=" * 60)
    uvicorn.run(app, host="0.0.0.0", port=ESCALATION_AGENT_PORT)
